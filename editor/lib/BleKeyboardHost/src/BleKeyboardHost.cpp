...
// BleHostConfig.h in place of freeink-sdk's BoardConfig.h: the four build
// switches this file reads, with their defaults, and nothing else. See that
// header for why.
#include <BleHostConfig.h>
